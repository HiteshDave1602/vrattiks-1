      ...
      <div className='container mx-auto lg:px-20 px-7'>
        <div className='md:grid grid-cols-3 gap-12'>
          ...
          <div className=' mb-7 md:mb-0 text-center'>
            ...
            <ul>
              <li className='mb-2 md:mb-5'><a href='#'>About Us</a></li>
          ...
          <div className=' mb-7 md:mb-0 text-center'>
            <h4 className='text-white text-xl  mb-2 md:mb-4'>Contact</h4>
             <ul>
              <li className='mb-2 md:mb-5'><b>Phone :</b> <a href='tel:+91 9106836019'>+91 9106836019</a></li>
              <li className='mb-2 md:mb-5'><b>Email :</b> <a href='mail:vrattiks@gmail.com'>vrattiks@gmail.com</a></li>
            </ul>
            <div className='mt-7 md:mt-0'>
              <div className='flex justify-center'>
                <a href='#' className='mx-3 text-lg'><SlSocialFacebook/></a>
                <a href='#' className='mx-3 text-lg'><FiTwitter/></a>
                <a href='#' className='mx-3 text-lg'><FiLinkedin/></a>
              </div>
            </div>
          </div>
        </div>
